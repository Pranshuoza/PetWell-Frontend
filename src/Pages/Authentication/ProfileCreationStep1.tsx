    ...
    <div className="min-h-screen bg-[#1C232E] flex flex-col items-center justify-center w-full relative">
      ...
      <div className="flex flex-col items-center flex-1 w-full max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-8 mt-2 mb-8 w-full max-w-3xl">
          ...
          {/* Step 2 */}
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full border-2 border-[#EBD5BD] flex items-center justify-center text-[#EBD5BD] font-bold bg-transparent">2</div>
        ...
        {/* Subtitle */}
        <h2 className="text-2xl font-[Cabin,sans-serif] text-[#EBD5BD] font-normal mb-8 mt-2">Let's start with your pet's details</h2>
        {/* Form */}
        <form className="w-full max-w-2xl flex flex-col gap-5" onSubmit={e => { e.preventDefault(); setStep(2); }}>
          <div>
            <label className="block text-[#EBD5BD] text-base mb-2">What's your pet's name?</label>
          ...
          <div>
            <label className="block text-[#EBD5BD] text-base mb-2">How old are they?</label>
            <select className="w-full rounded-md px-4 py-3 text-base bg-white text-black focus:outline-none">
              <option>Select age</option>
            </select>
          </div>
          <div>
            <label className="block text-[#EBD5BD] text-base mb-2">What species are they?</label>
            <select className="w-full rounded-md px-4 py-3 text-base bg-white text-black focus:outline-none">
              <option>Select species</option>
            </select>
          </div>
          <div>
            <label className="block text-[#EBD5BD] text-base mb-2">What breed are they?</label>
            <select className="w-full rounded-md px-4 py-3 text-base bg-white text-black focus:outline-none">
              <option>Select breed</option>
            </select>
          </div>
          <div>
            <label className="block text-[#EBD5BD] text-base mb-2">Upload a profile picture! <span className="font-normal">(Make it boop-worthy!)</span></label>
