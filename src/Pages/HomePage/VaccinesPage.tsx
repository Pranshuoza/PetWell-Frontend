      ...
      <div className="max-w-8xl mx-auto px-12 pt-4 pb-12">
        <div className="flex items-center justify-between gap-4 mb-8">
          ...
          <div className="flex gap-4">
            ...
            <button className="py-2 px-4 rounded-lg border border-[#FFA500] text-[#FFA500] font-semibold text-lg hover:bg-[#FFA500] hover:text-white transition flex items-center justify-center bg-transparent">
