...
const Navbar: React.FC<NavbarProps> = ({ onSwitchProfile }) => {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <div className={`fixed top-0 left-0 h-full w-64 bg-[var(--color-card)] shadow-2xl transform transition-transform duration-300 ease-in-out z-50 lg:hidden mobile-menu ${
        ...
        />
              <span className="text-lg font-bold text-[var(--color-text)]">PetWell</span>
            </div>
            <button
          ...
          <div className="p-4 border-t border-[var(--color-border)]">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-[var(--color-text)]">{petName}</p>
                <button
              ...
              <div className="mb-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-card)]">
                <div className="px-4 pt-4 pb-2 border-b border-[var(--color-border)]">
                  ...
                  <div className="flex gap-2 mb-2 justify-center items-center">
                    <span className="inline-flex w-8 h-8 bg-[#fff] bg-opacity-80 text-[#23272f] text-lg font-extrabold rounded-lg items-center justify-center border-2 border-[#EBD5BD] shadow-sm tracking-widest select-all transition-all duration-150 hover:scale-105 text-center">
                      X
                    </span>
                    <span className="inline-flex w-8 h-8 bg-[#fff] bg-opacity-80 text-[#23272f] text-lg font-extrabold rounded-lg items-center justify-center border-2 border-[#EBD5BD] shadow-sm tracking-widest select-all transition-all duration-150 hover:scale-105 text-center">
                      8
      ...
      <nav className="flex flex-col sm:flex-row items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-6 bg-transparent w-full">
        ...
        <div className="hidden lg:flex relative items-center space-x-2 sm:space-x-3" ref={dropdownRef}>
